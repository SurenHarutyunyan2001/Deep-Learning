...
single_step_model.add(tf.keras.layers.LSTM(32, input_shape=x_train_single.shape[-2:]))  # Слой LSTM
single_step_model.add(tf.keras.layers.Dense(1))  # Полносвязный слой
