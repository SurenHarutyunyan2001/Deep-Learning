...
from keras.api.layers import Embedding, LSTM, Dense, GlobalAveragePooling1D, Dropout, AdditiveAttention
...
# Attention слой
attention_out = AdditiveAttention(use_scale = True)([lstm_out, lstm_out])
